...
class ShellScaffold extends ConsumerWidget {
  ...
  Widget _customerShell(BuildContext context, WidgetRef ref) {
    final blocking = ref.watch(customerBlockingBookingProvider).valueOrNull;
    final canBook = blocking == null;
    ...
    return TabShellBackScope(
      ...
      child: Scaffold(
        ...
        bottomNavigationBar: BottomAppBar(
          ...
          shape: canBook ? const CircularNotchedRectangle() : null,
          ...
          child: Row(
            ...
            children: [
              ...
              if (canBook) const SizedBox(width: 48),
